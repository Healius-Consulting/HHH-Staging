  ...
  return (
    <div className="page-body setup-required-page">
      <section className="card setup-required" role="status">
        ...
        <p>{intakeOnly
          ? 'Eligibility intake and tenant-scoped patient review are active. Prescriptions, orders, payments and Curaleaf actions remain locked until the LIVE integration gate is complete.'
