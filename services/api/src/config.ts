...
const schema = z.object({
  ...
  ALLOWED_ORIGINS: z.string().default('https://holistichealthhub.cc,https://holistichealthhub.live,https://hhh.thinktimeless.co.uk,https://portal.holistichealthhub.cc,https://portal.holistichealthhub.live,https://portal.hhh.thinktimeless.co.uk,http://localhost:5173,http://localhost:5174,http://127.0.0.1:5173,http://127.0.0.1:5174'),
  ...
  PUBLIC_APP_ORIGINS: z.string().default('https://holistichealthhub.cc,https://holistichealthhub.live,https://hhh.thinktimeless.co.uk'),
  PORTAL_APP_ORIGIN: z.url().default('https://portal.holistichealthhub.cc'),
  PORTAL_APP_ORIGINS: z.string().default('https://portal.holistichealthhub.cc,https://portal.holistichealthhub.live,https://portal.hhh.thinktimeless.co.uk'),
